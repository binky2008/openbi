...
public class GenerateScriptBean {

	private final static java.util.logging.Logger LOGGER = java.util.logging.Logger.getLogger(GenerateScriptBean.class.getPackage().getName());
	...
	public void generateScripts() throws Exception {
		...
		FileInputBean templateFile = new FileInputBean();
		...
		String scriptName = "";
		String options = "";
		FileOutputBean scriptFile = new FileOutputBean();
