CREATE OR REPLACE PACKAGE pkg_etl_framework AUTHID CURRENT_USER
AS
   /**
   * $Author: nmarangoni $
   * $Date: 2011-08-08 10:39:20 +0200 (Mo, 08 Aug 2011) $
   * $Revision: 1200 $
   * $Id: pkg_etl_framework-def.sql 1200 2011-08-08 08:39:20Z nmarangoni $
   * $HeadURL: svn://qwp1466/svn_repository_bic/edwh/dwso/edwh_adm/packages/pkg_etl_framework/pkg_etl_framework-def.sql $
   */
    ...
    */
   c_spec_version   CONSTANT VARCHAR2 (1024) := '$Id: pkg_etl_framework-def.sql 1200 2011-08-08 08:39:20Z nmarangoni $';
   /**
    * Package spec repository URL.
    */
   c_spec_url       CONSTANT VARCHAR2 (1024) := '$HeadURL: svn://qwp1466/svn_repository_bic/edwh/dwso/edwh_adm/packages/pkg_etl_framework/pkg_etl_framework-def.sql $';
   /**
