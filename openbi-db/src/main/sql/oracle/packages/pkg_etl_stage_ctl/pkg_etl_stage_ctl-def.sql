CREATE OR REPLACE PACKAGE pkg_etl_stage_ctl AUTHID CURRENT_USER
AS
   /**
    * $Author: nmarangoni $
    * $Date: 2012-06-08 15:34:39 +0200 (Fr, 08 Jun 2012) $
    * $Revision: 2858 $
    * $Id: pkg_etl_stage_ctl-def.sql 2858 2012-06-08 13:34:39Z nmarangoni $
    * $HeadURL: svn://qwd4067/svn_repository_bic/edwh/dwso/edwh_adm/packages/pkg_etl_stage_ctl/pkg_etl_stage_ctl-def.sql $
    */

   /**
    * Package spec version string.
    */
   c_spec_version   CONSTANT VARCHAR2 (1024) := '$Id: pkg_etl_stage_ctl-def.sql 2858 2012-06-08 13:34:39Z nmarangoni $';
   /**
    * Package spec repository URL.
    */
   c_spec_url       CONSTANT VARCHAR2 (1024) := '$HeadURL: svn://qwd4067/svn_repository_bic/edwh/dwso/edwh_adm/packages/pkg_etl_stage_ctl/pkg_etl_stage_ctl-def.sql $';
   /**
