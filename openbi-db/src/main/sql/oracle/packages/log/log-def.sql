CREATE OR REPLACE PACKAGE aux_log AS
  /**
  * APIs for Logging and Tracing in the table aux_log_t on through DBMS_OUTPUT.
  *
  * $Author: nmarangoni $
  * $Date: $
  * $Revision: $
  ...
  */
  ...
  /**
  * Log a message to DBMS_OUTPUT and/or in the table aux_log_t
  *
