CREATE OR REPLACE PACKAGE stg_build AUTHID CURRENT_USER
AS
   /**
    * $Author: nmarangoni $
    * $Date: 2012-07-30 16:17:55 +0200 (Mo, 30 Jul 2012) $
    * $Revision: 3082 $
    * $Id: stg_build-def.sql 3082 2012-07-30 14:17:55Z nmarangoni $
    * $HeadURL: svn://qwd4067/svn_repository_bic/edwh/dwso/edwh_adm/packages/stg_build/stg_build-def.sql $
    */

   /**
    * Package spec version string.
    */
   c_spec_version   CONSTANT VARCHAR2 (1024) := '$Id: stg_build-def.sql 3082 2012-07-30 14:17:55Z nmarangoni $';
   /**
    * Package spec repository URL.
    */
   c_spec_url       CONSTANT VARCHAR2 (1024) := '$HeadURL: svn://qwd4067/svn_repository_bic/edwh/dwso/edwh_adm/packages/stg_build/stg_build-def.sql $';
   /**
