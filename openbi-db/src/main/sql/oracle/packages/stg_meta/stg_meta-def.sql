...
AS
    ...
    * $Revision: 2876 $
    * $Id: stg_meta-def.sql 2876 2012-06-20 13:27:31Z nmarangoni $
    * $HeadURL: svn://qwd4067/svn_repository_bic/edwh/dwso/edwh_adm/packages/stg_meta/stg_meta-def.sql $
    */

   /**
    * Package spec version string.
    */
   c_spec_version   CONSTANT VARCHAR2 (1024) := '$Id: stg_meta-def.sql 2876 2012-06-20 13:27:31Z nmarangoni $';
   /**
    * Package spec repository URL.
    */
   c_spec_url       CONSTANT VARCHAR2 (1024) := '$HeadURL: svn://qwd4067/svn_repository_bic/edwh/dwso/edwh_adm/packages/stg_meta/stg_meta-def.sql $';
   /**
