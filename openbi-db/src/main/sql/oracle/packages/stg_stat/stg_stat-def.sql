CREATE OR REPLACE PACKAGE stg_stat AUTHID CURRENT_USER
AS
   /**
    ...
    * $Revision: 1566 $
    * $Id: stg_stat-def.sql 1566 2011-10-05 11:37:55Z nmarangoni $
    * $HeadURL: svn://qwp1466/svn_repository_bic/edwh/dwso/edwh_adm/packages/stg_stat/stg_stat-def.sql $
    */

   /**
    * Package spec version string.
    */
   c_spec_version   CONSTANT VARCHAR2 (1024) := '$Id: stg_stat-def.sql 1566 2011-10-05 11:37:55Z nmarangoni $';
   /**
    * Package spec repository URL.
    */
   c_spec_url       CONSTANT VARCHAR2 (1024) := '$HeadURL: svn://qwp1466/svn_repository_bic/edwh/dwso/edwh_adm/packages/stg_stat/stg_stat-def.sql $';
   /**
