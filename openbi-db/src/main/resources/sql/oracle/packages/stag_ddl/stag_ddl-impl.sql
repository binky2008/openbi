...
';
   ...
   PROCEDURE prc_create_prc_trunc_stg1 (p_b_raise_flag BOOLEAN DEFAULT FALSE)
   IS
      l_vc_message       VARCHAR2 (32000)
      ...
      FOR i IN g_l_distr_code.FIRST .. g_l_distr_code.LAST LOOP
        ...
        AND g_vc_col_pk_src IS NOT NULL THEN
         ...
         ddls.prc_set_text_param (
          ...
          , 'backwardCompColumns'
          , CASE
               WHEN l_vc_uk_column_name IS NOT NULL THEN
                     l_vc_uk_column_name
                  || ' ,'
            END
         );
         ddls.prc_set_text_param (
          ...
          , 'backwardCompValues'
          , CASE
               WHEN l_vc_uk_sequence_name IS NOT NULL THEN
   ...
   PROCEDURE prc_create_prc_stage1 (p_b_raise_flag BOOLEAN DEFAULT FALSE)
   IS
      l_vc_message       VARCHAR2 (32000)
   ...
   PROCEDURE prc_create_prc_stage1_p (p_b_raise_flag BOOLEAN DEFAULT FALSE)
   IS
      l_vc_message          VARCHAR2 (32000)
   ...
   PROCEDURE prc_create_prc_stage2 (p_b_raise_flag BOOLEAN DEFAULT FALSE)
   IS
      l_vc_message           VARCHAR2 (32000)
   ...
   PROCEDURE prc_create_prc_diff_to_stg2 (p_b_raise_flag BOOLEAN DEFAULT FALSE)
   IS
      l_vc_message           VARCHAR2 (32000)
